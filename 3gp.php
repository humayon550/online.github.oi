...
if($_GET['d'])
{
curl_setopt($ch, CURLOPT_URL, 'videos.fusionbd.com/index.php?'.$_SERVER['QUERY_STRING'].'');
}
else
{
curl_setopt($ch, CURLOPT_URL, 'videos.fusionbd.com/index.php?'.$_SERVER['QUERY_STRING'].'');
...
$page = curl_exec($ch);
curl_close($ch);
$page = preg_replace("|index.php|","3gp.php",$page);
$page = preg_replace("|file.php|","dload.php",$page);
$page = preg_replace("|p=0|","p=1",$page);
...
$page = preg_replace('|'.$site.'.3gp.jpg|','FusionBD.Com.3gp.jpg',$page);
$page = preg_replace('| 2011|',' 2005-2014',$page);
echo $page;
echo $ads;
?>